...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Task1ControllerNameAnalyzerCodeFixProvider)), Shared]
    public class Task1ControllerNameAnalyzerCodeFixProvider : CodeFixProvider
    {
        ...
        {
            get { return ImmutableArray.Create(Task1ControllerNameAnalyzerAnalyzer.DiagnosticId); }
        }
